...
//define hexbug
String hexBug_portName = "COM10";  //starts as N/A but is selected from control panel to match your OpenBCI USB Dongle's serial/COM
Serial hexBug_serial;
int hexBug_baud = 9600; //baud rate from the Arduino
HexBug hexBug;
String val;
